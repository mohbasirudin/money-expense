...
class CategoryData extends DataClass implements Insertable<CategoryData> {
  ...
  CategoryData copyWith({int? id, String? name, String? color, String? icon}) =>
      CategoryData(
        id: id ?? this.id,
        name: name ?? this.name,
...
abstract class _$TbCategory extends GeneratedDatabase {
  _$TbCategory(QueryExecutor e) : super(e);
